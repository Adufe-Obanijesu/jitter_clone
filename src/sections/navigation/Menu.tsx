...
export default function Menu() {
  return (
    <nav id="menu" className="lg:hidden flex flex-col gap-4 h-full py-5 px-6 fixed z-40 top-0 left-0 w-full invisible pointer-events-none">
        <div id="menu-overlay" className="absolute top-0 left-0 w-full h-full bg-light-grey scale-y-0 shadow-2xl" />
