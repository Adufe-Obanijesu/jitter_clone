...
export default function UseCases() {
  ...
  return (
    <section className="lg:max-w-[860px] max-w-[400px] mx-auto mobile_padding">
      <div
        id="use-cases"
        className="invisible bg-light-grey lg:rounded-[80px] rounded-[20px] py-5 lg:p-[60px] lg:-mx-[60px] mt-[180px]"
      >
                  ...
                  <div className="w-full flex-1 flex items-center justify-center bg-white">
                    <div className="w-full relative aspect-square max-h-[400px] h-[calc(100vw-80px)]">
                      ...
                      <div className="absolute left-0 top-0 w-full h-full flex items-center z-0">
                        <video
                          ref={
                            tab.id === state.activeTab && state.isMobile
                              ? refs.videoRef
                              : undefined
                          }
                          src={tab.media.videoSrc}
